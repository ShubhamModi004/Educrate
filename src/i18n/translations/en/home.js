export default {
  ...
  "By going through series of articles, expert opinions and research papers, EDUCRATE team has realised the following skills ought to be introduced in the classrooms.": "By going through series of articles, expert opinions and research papers, EDUCRATE team has realised the following skills ought to be introduced in the classrooms.",
  "We have almost touched almost 150 topics for the children, which can be divided into 5 broad categories": "We have almost touched almost 150 topics for the children, which can be divided into 5 broad categories",
  'Entrepreneur skills': 'Entrepreneur skills',
  'Grassroot Innovation': 'Grassroot Innovation',
  'Drawing environment posters for awareness classroom': 'Drawing environment posters for awareness classroom',
  'We should not contribute to greenhouse gases': 'We should not contribute to greenhouse gases',
  ...
  'Importance of  saving water': 'Importance of  saving water',
  'Operation of devices of Computer': 'Operation of devices of Computer',
  'Importance Of traffic rules for safety': 'Importance Of traffic rules for safety',
  'Benefits of electricity saving and importance of solar energy': 'Benefits of electricity saving and importance of solar energy',
  'Cleanliness and Disease prevention': 'Cleanliness and Disease prevention',
  'Golden and glorious India and brotherhood': 'Golden and glorious India and brotherhood',
  'Conservation of earth resources to maintain balance': 'Conservation of earth resources to maintain balance',
  'India integration': 'India integration',
  'Freedom fighters of India': 'Freedom fighters of India',
  'Importance of hand wash in prevention of disease': 'Importance of hand wash in prevention of disease',
  'Anthem for school kids': 'Anthem for school kids',
  'Importance of ganga river': 'Importance of ganga river',
  'About Indian constitution': 'About Indian constitution',
  'Importance of Indian farmer': 'Importance of Indian farmer',
  'Attendance in school': 'Attendance in school',
  'Meaning of National Anthem': 'Meaning of National Anthem',
  'Republic of India meaning': 'Republic of India meaning',
  'Importance of national flag': 'Importance of national flag',
  'India space power': 'India space power',
  'Culture of India, Festivals and their relevance': 'Culture of India, Festivals and their relevance',
  'Importance of vaccination for immunity': 'Importance of vaccination for immunity',
  'Financial literacy': 'Financial literacy',
  'Prevention of cholera': 'Prevention of cholera',
  'Army pride': 'Army pride',
  'Wind energy': 'Wind energy',
  'History of National Anthem': 'History of National Anthem',
  'The basic principles of constitution': 'The basic principles of constitution',


  // sites
  'Slow and steady wins the race': 'Slow and steady wins the race',
  'Humaniatarism': 'Humaniatarism',
  'School learning will always help in future': 'School learning will always help in future',
  'Morals for kids to implement in daily life': 'Morals for kids to implement in daily life',
  'Teachers importance': 'Teachers importance',
  'Practice makes the man perfect': 'Practice makes the man perfect',
  'Perseverance and Keep trying attitude': 'Perseverance and Keep trying attitude',
  'Respecting your parents': 'Respecting your parents',
  ...
  'Value of education in persons life': 'Value of education in persons life',
  'Everyone has talent to bring change': 'Everyone has talent to bring change',
  'Pursuing sports as career': 'Pursuing sports as career',
  'Study for learning': 'Study for learning',
  'To study and work for nation': 'To study and work for nation',
  'Not to fear from studies': 'Not to fear from studies',
  'Dream big': 'Dream big',
  'Importance of  yoga': 'Importance of  yoga',
  'Obesity is a major health problem': 'Obesity is a major health problem',
  'Interest in subject can lead you to success in your life': 'Interest in subject can lead you to success in your life',
  'Complete your task in timely manner(Time management)': 'Complete your task in timely manner(Time management)',
  'Listen to your heart and be courageous with your plans': 'Listen to your heart and be courageous with your plans',
  'Be careful what you wish for': 'Be careful what you wish for',
  'To follow your dreams in student life': 'To follow your dreams in student life',
  'Importance of nature and wildlife for earth': 'Importance of nature and wildlife for earth',
  'Overcoming your failures to become great': 'Overcoming your failures to become great',
  'Not to waste water': 'Not to waste water',
  'Children from small towns can also be great': 'Children from small towns can also be great',
  'Practice makes one perfect in sports': 'Practice makes one perfect in sports',
  'To be persistent': 'To be persistent',
  'Follow knowledge not results': 'Follow knowledge not results',



  'Honesty': 'Honesty',
  'Social awareness': 'Social awareness',
  'Everyone should make their opinion and respect others': 'Everyone should make their opinion and respect other',
  'Social etiquette and good behaviour': 'Social etiquette and good behaviour',
  'To not be jealous and greedy of neighbour': 'To not be jealous and greedy of neighbour',
  'Overcome inferiority complex': 'Overcome inferiority complex',
  'Anti-bullying': 'Anti-bullying',
  'Problem sharing with parents and teachers': 'Problem sharing with parents and teachers',
  'Humbleness': 'Humbleness',
  'Girls education impact whole society': 'Girls education impact whole society',
  'Vital human values': 'Vital human values',
  'Bullying and teasing should not be done, it can disturb someone’s well being': 'Bullying and teasing should not be done, it can disturb someone’s well being',
  'Both male and female are equal': 'Both male and female are equal',
  'Basic Human Rights': 'Basic Human Rights',
  'Empathy with animals': 'Empathy with animals',
  'Donations can make people happy': 'Donations can make people happy',


  "We recommend teachers to use the hard copy of the above skill set and to make their own schedule to use them as needed.": "We recommend teachers to use the hard copy of the above skill set and to make their own schedule to use them as needed.",
  "Skills we want for children to be prepared for the modern world": "Skills we want for children to be prepared for the modern world",
  "Certification for skills": "Certification for skills",
  "To take more progressive steps towards usage of Knowledge bank in school curriculum we have introduced the certification course in regards to Knowledge Bank, so the students are being rewarded for better understanding of the above mentioned skills.": "To take more progressive steps towards usage of Knowledge bank in school curriculum we have introduced the certification course in regards to Knowledge Bank, so the students are being rewarded for better understanding of the above mentioned skills.",
  "Skill Certificate Model": "Skill Certificate Model",
  "Teacher would select a Skill to be introduced before the classroom from table above": "Teacher would select a Skill to be introduced before the classroom from table above",
  "Teachers can give brief idea to students about the skills": "Teachers can give brief idea to students about the skills",
  "Teachers should access the Link": "Teachers should access the Link",
  "through Knowledge Bank": "through Knowledge Bank",
  "Students should watch the video": "Students should watch the video",
  "Teacher should encourage the discussion on the topic": "Teacher should encourage the discussion on the topic",
  "Teacher should award the certificate with respect to particular skill": "Teacher should award the certificate with respect to particular skill",
  "Click the photograph with Student": "Click the photograph with Student",
  ...
  "Problems Faced by Teachers": "Problems Faced by Teachers",
  "Traditional Hardware is difficult to operate": "Traditional Hardware is difficult to operate",
  "EDUCRATE can be operated just like normal Personal Computer, with Keyboard and mouse provided.": "EDUCRATE can be operated just like normal Personal Computer, with Keyboard and mouse provided.",
  "Hardware setup is difficult": "Hardware setup is difficult",
  "EDUCRATE has just one switch to start the classroom learning.": "EDUCRATE has just one switch to start the classroom learning.",
  "Less information towards newer pedagogical techniques.": "Less information towards newer pedagogical techniques.",
  "Teacher can readily access EDUCRATE to search the concept from youtube to present before the class.": "Teacher can readily access EDUCRATE to search the concept from youtube to present before the class.",
  "Application/software is complex to handle": "Application/software is complex to handle",
  "EDUCRATE operates in LINUX based operating system, which is the easiest software to use in smart classroom setting.": "EDUCRATE operates in LINUX based operating system, which is the easiest software to use in smart classroom setting.",
  "Extensive curriculum to cover": "Extensive curriculum to cover",
  "Knowledge bank videos are of short duration to adjust at least once a week for the students without affecting normal teaching-curriculum.": "Knowledge bank videos are of short duration to adjust at least once a week for the students without affecting normal teaching-curriculum.",
  "Language Barrier in content": "Language Barrier in content",
  ...
  "Lack of Communication between student and teacher": "Lack of Communication between student and teacher",
  "EDUCRATE promoter two way communication between student - teacher and amongst students as well through Group discussion certificates and skill topics.": "EDUCRATE promoter two way communication between student - teacher and amongst students as well through Group discussion certificates and skill topics.",
  "Capturing Important photographs in joy moments of classroom": "Capturing Important photographs in joy moments of classroom",
  "EDUCRATE has camera feature to capture all the important moments of the classrooms.": "EDUCRATE has camera feature to capture all the important moments of the classrooms.",
  "Lack of awareness about Flipped Learning": "Lack of awareness about Flipped Learning",
  "EDUCRATE promotes sharing of topics well in advance with students, and students go through it, forming an understanding of the topic so that they can facilitate discussion on and elaboration of the topic.": "EDUCRATE promotes sharing of topics well in advance with students, and students go through it, forming an understanding of the topic so that they can facilitate discussion on and elaboration of the topic.",
  "Problems Faced by Parents": "Problems Faced by Parents",
  "Soft skill development of child": "Soft skill development of child",
  "EDUCRATE through KNOWLEDGE BANK is focussed on skills beyond curriculum.": "EDUCRATE through KNOWLEDGE BANK is focussed on skills beyond curriculum.",
  "Digital literacy": "Digital literacy",
  "Knowledge Bank has included videos to explain the limited use of technology.": "Knowledge Bank has included videos to explain the limited use of technology.",
  "Learning better morals": "Learning better morals",
  "Knowledge Bank has shared age-wise good stories to help children to grow a good and honest citizen.": "Knowledge Bank has shared age-wise good stories to help children to grow a good and honest citizen.",
  "Increase in Fee": "Increase in Fee",
  "EDUCRATE with school operators tries not to burden parents financially for smart content delivery.": "EDUCRATE with school operators tries not to burden parents financially for smart content delivery.",
  "Learning results": "Learning results",
  "EDUCRATE works on reward and appreciation psychology of child to make the classroom more interesting": "EDUCRATE works on reward and appreciation psychology of child to make the classroom more interesting",
  "Lack of multidimensional learning": "Lack of multidimensional learning",
  "EDUCRATE through KNOWLEDGE BANK attempts to cognitive, physical, social, emotional and ethical development of each child.": "EDUCRATE through KNOWLEDGE BANK attempts to cognitive, physical, social, emotional and ethical development of each child.",
  "Smart Learning for their kids": "Smart Learning for their kids",
  "EDUCRATE is an investment to every parent’s dream of good quality education for their children.": "EDUCRATE is an investment to every parent’s dream of good quality education for their children.",
