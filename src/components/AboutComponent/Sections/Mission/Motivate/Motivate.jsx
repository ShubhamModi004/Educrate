    ...
    render() {
        return (
            <div className="mission-strive-section">
                <h5><FormattedMessage id="home.MOTIVATE" /></h5>
                <div className="mission-strive-section-image-container">
                    <MotivateImage />
                </div>
                <p>
                    <FormattedMessage id="home.EDUCRATE aims to provide equal opportunity of learning and aspirations to every Child. The teachers are facing problem in classroom with respect to hardware for delivery of content available online. Through our EDUCRATE teachers can avail content and practices in internet/online readily so that children can perform to their best potential." />
                </p>
            </div>
        )
    }
