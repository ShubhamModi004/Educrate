        ...
        return (
            <div className="home-main-title container">
                <div className="main-title">
                    ...
                    <p><FormattedMessage id="home.Educrate was created by keeping in mind that digital/smart classroom concept should reach all the students, every student should have equal access to the technological advancements in the field of education and moreover audio visual content should reach them, at minimal cost." /></p>
