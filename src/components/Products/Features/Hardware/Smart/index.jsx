        ...
        return (
            <div className="smart-product-classroom">
                    ...
                    <div className="smart-classroom-text mb-4">
                        <p className="product-page-smart-paragraph"><FormattedMessage id="Complete SmartClassroom Solution (CSS) is a combination of Educrate hardware & interactive whiteboard (green board optional)
