                ...
                <div className="knowledge-bank-landing-invitation">
                    <div className="knowledge-blue-section">
                        <div className="knowledge-invitation-link">
                            ...
                            <h6>Register to get an invite</h6>
                            <div className="googledoc">
                                <Googledoc />
                            </div>
                            <form className="knowledge-form" action="https://formspree.io/lifeofpixels0707@gmail.com" method="POST">
                                <input className="knowledge-email" type="email" id="fname" name="email" placeholder="EMAIL ID" />
                                <input type="submit" value="Submit" className="yellowButtons" style={{ marginTop: '1.5rem', width: '9rem', border: 'none', outline: 'none' }} />
                            </form>
                        </div>
                    </div>
                </div>
